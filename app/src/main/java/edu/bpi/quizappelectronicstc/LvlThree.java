...
public class LvlThree extends AppCompatActivity {
    ...
    private final String TOP_SCORE_KEY = "TOP_SCORE_LVL3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (questionsList.size() > 0) {
            questions3.setText(questionsList.get(currentQuestion).getPrompt());
        }
    ...
    private void loadQuestionsFromJSON() {
        try {
            ...
            JSONArray questionsArray = jsonObject.getJSONArray("questionsthree");
    ...
    private void presentNextQuestion() {
        ...
        } else if(tscore3 >= questionsList.size() - 1){
